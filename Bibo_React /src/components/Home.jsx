...
function Home() {
  ...
  useEffect(() => {
    const categories = ["romance", "fiction", "history", "science"];//as categorias dos livros 
...
//................ Calculo da Paginação .....................//
  const indexOfLastItem = currentPage * itemsPerPage; //Calcula o índice do último livro da página atual.
  const indexOfFirstItem = indexOfLastItem - itemsPerPage; //Calcula o índice do primeiro livro da página atual.
  //livros que sao exibidos na página atual.
  ...
  const totalPages = Math.ceil( //num total de paginas para aparecerem todos os livros
